    ...
    <div class="mt-8">
        <form action="{{ route('tasks.index') }}" method="GET">
            <div class="flex flex-wrap items-center">
                ...
                <div class="ml-4">
                    <button type="submit" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Apply Filters</button>
                </div>
            </div>
        </form>
    </div>
